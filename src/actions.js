...
export const GET_SINGLE_PROUCT_BEGIN = "GET_SINGLE_PROUCT_BEGIN";
export const GET_SINGLE_PROUCT_SUCCESS = "GET_SINGLE_PROUCT_SUCCESS";
export const GET_SINGLE_PROUCT_ERROR = "GET_SINGLE_PROUCT_ERROR";
